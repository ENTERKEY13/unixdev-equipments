...
<body>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
{{--                <a class="navbar-brand" href="{{ route(Auth::user() && Auth::user()->is_admin ? 'admin.equipment_list' : 'user.unix.equipment_list') }}">--}}
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <div class="d-flex gap-3 align-items-center">
                                        <a class="nav-link" href="{{ route('admin.user_equipment_list') }}">
                                            User Equipment List
                                        </a>
                                    <a class="nav-link" href="{{ route('admin.equipment_list') }}">
                                        Equipment List
                                    </a>
